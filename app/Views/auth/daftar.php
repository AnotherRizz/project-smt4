                        ...
                        <div class="col-8 z-2">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class=" mb-4">Halaman Registrasi</h1>
                                </div>

                                <form class="user" method="post" action="<?= base_url('auth/daftar'); ?>">
                                    <div class="mb-3 mt-4">
                                        <input type="text"
                                            class="focus-ring focus-ring-warning form-control form-control" name="nama"
                                            id="nama" placeholder="Nama Anda" autocomplete="off" required>
                                    </div>
                                    <div class="mb-3 mt-4">
                                        <input type="email"
                                    ...
                                    <div class="mb-3">
                                        <input type="password"
                                            class="focus-ring focus-ring-warning form-control form-control" name="password"
